...
\begin{figure}[h!]
  ...
  \caption{Comparison of GPT-3.5 Turbo and multi-task fine-tuned model for Patient Journey 1-5~\aref{apx:pjs} for the task \quotes{Activity Labelling}}
...
\begin{figure}[h!t]
    ...
    \caption{Comparison of GPT-3.5 Turbo and multi-task fine-tuned model across all Patient Journeys~\aref{apx:pjs} for the task \quotes{Activity Labelling}} 
...
\begin{figure}[ht]
    ...
    \caption{Comparison of GPT-3.5 Turbo and multi-task fine-tuned model across all Patient Journeys~\aref{apx:pjs} for the task \quotes{Event Type Classification}}
...
\begin{figure}[h!]
    ...
    \caption{Comparison of GPT-3.5 Turbo and multi-task fine-tuned model across all Patient Journeys~\aref{apx:pjs} for the task \quotes{Timestamp Extraction}}
    \label{fig:eval_time}
\end{figure}
...
\begin{figure}[h]
  ...
  \caption{Comparison of GPT-3.5 Turbo and the Single-Task Fine-Tuned model for Patient Journey 1-5~\aref{apx:pjs} for the task \quotes{Activity Labelling}}
...
\begin{figure}[ht]
    ...
    \caption{Comparison of GPT-3.5 Turbo and  Single-Task Fine-Tuned model across all Patient Journeys~\aref{apx:pjs} for the task \quotes{Activity Labelling}} 
...
\begin{figure}[th]
    ...
    \caption{Comparison of multi-task and single-task fine-tuned model across all Patient Journeys~\aref{apx:pjs} for the task \quotes{Activity Labelling}} 
