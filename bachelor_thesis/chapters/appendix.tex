...
\paragraph{Patient Journey 1}\label{apx:pj1}
...
\paragraph{Patient Journey 2}\label{apx:pj2}
...
\paragraph{Patient Journey 3}\label{apx:pj3}
...
\paragraph{Patient Journey 4}\label{apx:pj4}
...
\paragraph{Patient Journey 5}\label{apx:pj5} (Shortened from~\cite{malta_my_2020})\\
...
%         \missing
%     }
%     \caption{Missing activites for Patient Journey 2~\ref{apx:pj2}}
%     \label{tab:pj2-missing}
% \end{table}
